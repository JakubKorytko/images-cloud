...
import { Navbar, Container, Nav, Stack, FormLabel, Button, Dropdown } from 'react-bootstrap';
import { ArrowUp, CloudFill, ArrowDown, BoxArrowRight } from 'react-bootstrap-icons';
    ...
    return (
      <header className={`sticky-top d-${this.props.navbarDisplay}`}>
        <Navbar data-testid="menu" bg="dark" variant="dark" expand={this.props.selectionCount>0?"xl":"lg"}>
          <Container fluid>
            <Navbar.Brand className="my-1 mx-3" href="#"><CloudFill /> images-cloud</Navbar.Brand>
            ...
            <Navbar.Collapse>
              ...
              <Nav.Item className="text-white mx-2">
                  ...
                  <Nav.Item className={`mx-2 text-light d-flex justify-content-center align-items-center nw ${btnClass}`}>
                    <span>Selected {this.props.selectionCount} items</span>
                  </Nav.Item>
