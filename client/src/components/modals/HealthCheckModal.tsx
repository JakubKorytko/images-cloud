  ...
  render() {
    return (
      <Modal centered show={this.props.show} onHide={this.closeHandler} animation={false}>
        ...
        <Modal.Body>There was an issue completing your request, on this website you can check if server is down and wait until it will start up again. If this was the mistake and server is running, return to the <a href="/">home page</a></Modal.Body>
        <Modal.Footer>
