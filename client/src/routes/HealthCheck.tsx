                        ...
                        <Card className="text-center">
                            ...
                            <Card.Body>
                                ...
                                <Card.Text aria-label="Server status">
                                    {this.state.serverStatus !== null ? <CircleFill aria-label="Server status icon" className={`align-baseline c-${textColor}`} /> : null} {statusText}
                                </Card.Text>
                            </Card.Body>
                            <Card.Footer className={`bg-${footerBg} text-muted`}>Last checked: {this.state.time}</Card.Footer>
                        </Card>
                    </Col>
                </Row>
